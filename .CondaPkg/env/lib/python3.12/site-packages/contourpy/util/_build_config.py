...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"/Users/elevien/Dartmouth College Dropbox/Ethan Levien/RESEARCH/ACTIVE_PAPERS/L1210_growth_rate_fluctuations/L1210/.CondaPkg/env/bin/python",
